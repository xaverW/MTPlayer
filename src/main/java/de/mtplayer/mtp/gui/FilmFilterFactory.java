...
public class FilmFilterFactory extends FilterController {
    ...
    public FilmFilterFactory() {
        super();
        progData = ProgData.getInstance();

        filter = new FilmFilterControllerFilter();
//        filter.setStyle("-fx-border-color: red;");
        clearFilter = new FilmFilterControllerClearFilter();
//        clearFilter.setStyle("-fx-border-color: blue;");
        profiles = new FilmFilterControllerProfiles();
//        profiles.setStyle("-fx-border-color: green;");
