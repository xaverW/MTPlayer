...
//             ProgConfig.SYSTEM_GUI_COLOR.set("-pGuiColor: yellow;");
//            String gui = P2ColorFactory.getColor(ProgConfig.SYSTEM_GUI_COLOR.getValueSafe());

            P2CssFactory.addP2CssToScene(scene); // und jetzt noch CSS einstellen
//            String gui = "-pGuiColor: yellow;";
