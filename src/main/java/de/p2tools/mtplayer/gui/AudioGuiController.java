...
import de.p2tools.mtplayer.gui.tools.table.TableRowAudio;
...
public class AudioGuiController extends AnchorPane {
    ...
    public final TableAudio tableView;
    ...
    public AudioGuiController() {
        ...
        closePaneController = new P2ClosePaneController(list, ProgConfig.AUDIO__INFO_IS_SHOWING);
        ...
        ProgConfig.AUDIO__BUTTON_PANE_IS_RIP.addListener((observable, oldValue, newValue) -> setInfoPane());
        ProgConfig.AUDIO__MEDIA_PANE_IS_RIP.addListener((observable, oldValue, newValue) -> setInfoPane());
    ...
    public void saveTable() {
        Table.saveTable(tableView, Table.TABLE_ENUM.AUDIO);
    }
    ...
    private void initTable() {
        ...
        tableView.setRowFactory(new P2RowFactory<>(tableView -> {
            TableRowAudio<FilmDataMTP> row = new TableRowAudio<>();
    ...
    private void setInfoPane() {
        P2ClosePaneFactory.setSplit(boundInfo, splitPane,
                closePaneController, false, scrollPaneTable,
    ...
    private void initDto(MediaDataDto mediaDataDtoMedia, MediaDataDto mediaDataDtoAbo) {
        ...
        mediaDataDtoMedia.buildSearchFrom = ProgConfig.INFO_AUDIO_BUILD_SEARCH_FROM_FOR_MEDIA;
        mediaDataDtoMedia.searchInWhat = ProgConfig.INFO_AUDIO_SEARCH_IN_WHAT_FOR_MEDIA;
        mediaDataDtoMedia.cleaning = ProgConfig.INFO_AUDIO_CLEAN_MEDIA;
        mediaDataDtoMedia.cleaningExact = ProgConfig.INFO_AUDIO_CLEAN_EXACT_MEDIA;
        mediaDataDtoMedia.cleaningAndOr = ProgConfig.INFO_AUDIO_CLEAN_AND_OR_MEDIA;
        mediaDataDtoMedia.cleaningList = ProgConfig.INFO_AUDIO_CLEAN_LIST_MEDIA;

        mediaDataDtoAbo.whatToShow = MediaDataDto.SHOW_WHAT.SHOW_ABO;
        mediaDataDtoAbo.buildSearchFrom = ProgConfig.INFO_AUDIO_BUILD_SEARCH_FROM_FOR_ABO;
        mediaDataDtoAbo.searchInWhat = ProgConfig.INFO_AUDIO_SEARCH_IN_WHAT_FOR_ABO;
        mediaDataDtoAbo.cleaning = ProgConfig.INFO_AUDIO_CLEAN_ABO;
        mediaDataDtoAbo.cleaningExact = ProgConfig.INFO_AUDIO_CLEAN_EXACT_ABO;
        mediaDataDtoAbo.cleaningAndOr = ProgConfig.INFO_AUDIO_CLEAN_AND_OR_ABO;
        mediaDataDtoAbo.cleaningList = ProgConfig.INFO_AUDIO_CLEAN_LIST_ABO;
    }
}
