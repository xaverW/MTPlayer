...
public class PaneIcon {
    ...
    private int addProgIcon(GridPane gridPane, int row) {
        ...
        final Button btnHelpProgramIcon = P2IconFactory.getHelpButton(stage, "Eigenes Bild als Programmicon anzeigen",
    ...
    private int addTryIcon(GridPane gridPane, int row) {
        ...
        final Button btnHelpTray = P2IconFactory.getHelpButton(stage, "Programm im System Tray anzeigen",
                HelpText.TRAY);
        ...
        final Button btnHelpTrayOwnIcon = P2IconFactory.getHelpButton(stage, "Eigenes Bild im Tray anzeigen",
