...
public class PaneBlack {
    ...
    private void makeBlack(VBox vBox) {
        ...
        final Button btnHelp = P2IconFactory.getHelpButton(stage, "Blacklist",
        ...
        final Button btnHelpFuture = P2IconFactory.getHelpButton(stage, "Blacklist",
        ...
        final Button btnHelpGeo = P2IconFactory.getHelpButton(stage, "Blacklist",
        ...
        final Button btnHelpDouble = P2IconFactory.getHelpButton(stage, "Blacklist",
                HelpText.BLACKLIST_DOUBLE);

        initDays();

        final Button btnHelpSize = P2IconFactory.getHelpButton(stage, "Blacklist",
                HelpText.BLACKLIST_SIZE);

        final Button btnHelpDays = P2IconFactory.getHelpButton(stage, "Blacklist",
