...
public class ResetDialogController extends P2DialogExtra {
    ...
    public void make() {
        ...
        P2BigButton setButton = new P2BigButton(P2IconFactory.P2ICON.P2__DIALOG_RESET.getFontIcon(),
        ...
        // alle Einstellungen
        P2BigButton allButton = new P2BigButton(P2IconFactory.P2ICON.P2__DIALOG_RESET.getFontIcon(), "" +
