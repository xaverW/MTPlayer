...
public class AboAddDialogGuiAbo extends VBox {
    ...
    private void addCont() {
        ...
        final Button btnHelpQ = P2IconFactory.getHelpButton(stage,
        ...
        final Button btnHelpRes = P2IconFactory.getHelpButton(stage,
        ...
        // Startzeit
        final Button btnHelpStartTime = P2IconFactory.getHelpButton(stage, "Startzeit",
