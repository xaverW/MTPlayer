...
public class InitProgramCall {
    ...
    private void init() {
        P2ClipBoardContext.addMenu("Programmaufruf kopieren", addDownloadDto.textAreaProg.textProperty(), addDownloadDto.textAreaProg);
...
//        addDownloadData.download.makeProgParameter();
        DownloadFactoryMakeParameter.makeProgParameter(addDownloadData.download);
