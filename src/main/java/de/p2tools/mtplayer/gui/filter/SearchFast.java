...
public class SearchFast extends HBox {
    ...
    private void make() {
        ...
        ProgConfig.FILM_GUI_FILTER_IS_SHOWING.addListener((observable, oldValue, newValue) -> {
            if (ProgConfig.FILM_GUI_FILTER_IS_SHOWING.getValue() && ProgConfig.FAST_SEARCH_ON.getValue()) {
    ...
    private void initListener() {
        btnSearch.setOnMouseClicked(mouseEvent -> {
            ...
            ProgConfig.FILM_GUI_FILTER_IS_SHOWING.setValue(!ProgConfig.FAST_SEARCH_ON.getValue());
        });
