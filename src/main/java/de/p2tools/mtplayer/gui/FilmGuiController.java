...
public class FilmGuiController extends AnchorPane {
    ...
    public FilmGuiController() {
        ...
        paneButton = new PaneFilmButton(PaneFilmButton.PANE.FILM);
        ...
        P2ClosePaneDto infoDto = new P2ClosePaneDto(paneFilmInfo,
                ...
                ProgConfig.FILM__INFO_DIALOG_SIZE, MTPlayerController.TAB_FILM_ON,
        ...
        infoDto = new P2ClosePaneDto(paneButton,
                ...
                ProgConfig.FILM__BUTTON_DIALOG_SIZE, MTPlayerController.TAB_FILM_ON,
        ...
        infoDto = new P2ClosePaneDto(paneMedia,
                ...
                ProgConfig.FILM__MEDIA_DIALOG_SIZE, MTPlayerController.TAB_FILM_ON,
...
//                        }
    ...
    private void setFilmInfos(FilmDataMTP film) {
        ...
        if (InfoPaneFactory.paneIsVisible(MTPlayerController.TAB_FILM_ON, paneFilmInfo)) {
            paneFilmInfo.setFilm(film);
        }
        if (InfoPaneFactory.paneIsVisible(MTPlayerController.TAB_FILM_ON, paneMedia)) {
