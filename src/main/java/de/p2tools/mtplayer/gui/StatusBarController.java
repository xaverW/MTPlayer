...
public class StatusBarController extends AnchorPane {
    ...
    private void setCircleStyle() {
        ...
        if (progData.downloadInfos.getFinishedError() > 0) {
            ...
            circleFilm.setFill(Paint.valueOf(ProgConfig.SYSTEM_THEME_DARK.getValue() ? "#c1c1c1" : "#666666"));
            circleAudio.setFill(Paint.valueOf(ProgConfig.SYSTEM_THEME_DARK.getValue() ? "#c1c1c1" : "#666666"));
            circleLive.setFill(Paint.valueOf(ProgConfig.SYSTEM_THEME_DARK.getValue() ? "#c1c1c1" : "#666666"));
            circleDownload.setFill(Paint.valueOf(ProgConfig.SYSTEM_THEME_DARK.getValue() ? "#c1c1c1" : "#666666"));
            circleAbo.setFill(Paint.valueOf(ProgConfig.SYSTEM_THEME_DARK.getValue() ? "#c1c1c1" : "#666666"));
        }
    }
