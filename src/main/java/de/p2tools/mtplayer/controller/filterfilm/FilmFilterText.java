...
public class FilmFilterText extends P2DataSample<FilmFilterText> implements Comparable<FilmFilterText> {
    ...
    public FilmFilterText(FilmFilter filmFilter) {
    ...
    public boolean filterIsSame(FilmFilterText tf) {
