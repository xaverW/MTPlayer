...
public class UpdateFactory {
    static final LocalDate whatsNewDate = LocalDate.of(2024, 2, 11); // erhöht sich, wenn whatsNew geändert wird
    ...
    public static boolean showWhatsNew(boolean showAlways) {
        ...
        try {
            ...
            if (!showAlways && !lastShown.isBefore(whatsNewDate)) {
                // dann gibts nix neues
                return false;
            }

            ArrayList<WhatsNewInfo> list = new ArrayList<>();
            list.add(new WhatsNewInfo("/de/p2tools/mtplayer/res/whatsnew/whatsNew_01.png",
                    "Doppelte Filme",
