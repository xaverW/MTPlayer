...
public class DownloadDataProps extends PDataSample<DownloadData> {
    ...
    public Config[] getConfigsArr() {
        ...
        list.add(new ConfigStringPropExtra("aboName", DownloadFieldNames.DOWNLOAD_ABO, aboName));
...
//        list.add(new ConfigPDateProp("filmDate", DownloadFieldNames.DOWNLOAD_NR, filmDate));
        ...
        list.add(new ConfigStringPropExtra("programCall", DownloadFieldNames.DOWNLOAD_PROGRAM_CALL, programCall));
        list.add(new ConfigStringPropExtra("programCallArray", DownloadFieldNames.DOWNLOAD_PROGRAM_CALL_ARRAY, programCallArray));
        list.add(new ConfigBoolPropExtra("programRestart", DownloadFieldNames.DOWNLOAD_PROGRAM_RESTART, programRestart));
        list.add(new ConfigBoolPropExtra("programDownloadmanager", DownloadFieldNames.DOWNLOAD_PROGRAM_DOWNLOADMANAGER, programDownloadmanager));
        list.add(new ConfigStringPropExtra("startTime", DownloadFieldNames.DOWNLOAD_START_TIME, startTime));
        ...
        list.add(new ConfigStringPropExtra("type", DownloadFieldNames.DOWNLOAD_TYPE, type));
        list.add(new ConfigStringPropExtra("source", DownloadFieldNames.DOWNLOAD_SOURCE, source));
