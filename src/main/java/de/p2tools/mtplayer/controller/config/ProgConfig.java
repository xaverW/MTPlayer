...
public class ProgConfig extends PDataProgConfig {
    ...
    public static StringProperty SHORTCUT_COPY_FILM_THEME_TO_CLIPBOARD = addStr("SHORTCUT_COPY_FILM_THEME_TO_CLIPBOARD", SHORTCUT_COPY_FILM_THEME_TO_CLIPBOARD_INIT);

    public static String SHORTCUT_COPY_FILM_TITLE_TO_CLIPBOARD_INIT = "Alt+T";
    public static StringProperty SHORTCUT_COPY_FILM_TITLE_TO_CLIPBOARD = addStr("SHORTCUT_COPY_FILM_TITLE_TO_CLIPBOARD", SHORTCUT_COPY_FILM_TITLE_TO_CLIPBOARD_INIT);
