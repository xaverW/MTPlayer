...
public class ProgConst {
    ...
    public static final String CSS_FILE = "de/p2tools/mtplayer/css/css_0/mtfx.css";
    public static final String CSS_FILE_DARK_THEME = "de/p2tools/mtplayer/css/css_0/mtfx-dark.css";
...
//    public static final String FILE_PROG_ICON = "/de/p2tools/mtplayer/res/P2.png";
    ...
    public static final double CONFIG_DIALOG_SET_DIVIDER = 0.5;
