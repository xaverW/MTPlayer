...
public class ProgIcons {
    ...
    public static P2Image ICON_BUTTON_UP_DOWN_H = new P2Image(ICON_PATH_LONG, "button-up-down-h.png", 26, 6);
    ...
    public static P2Image IMAGE_TABLE_FILM_BOOKMARK = new P2Image(ICON_PATH_LONG, "table-film-bookmark.png", 14, 14);
    public static P2Image IMAGE_TABLE_DOWNLOAD_START = new P2Image(ICON_PATH_LONG, "table-download-start.png", 14, 14);
    public static P2Image IMAGE_TABLE_DOWNLOAD_DEL = new P2Image(ICON_PATH_LONG, "table-download-del.png", 14, 14);
    public static P2Image IMAGE_TABLE_DOWNLOAD_STOP = new P2Image(ICON_PATH_LONG, "table-download-stop.png", 14, 14);
    public static P2Image IMAGE_TABLE_DOWNLOAD_OPEN_DIR = new P2Image(ICON_PATH_LONG, "table-download-open-dir.png", 14, 14);

    public static P2Image ICON_TOOLBAR_BUTTON_SEARCH = new P2Image(ICON_PATH_LONG, "toolbar-button-search.png", 24, 24);
    ...
    public static P2Image ICON_TOOLBAR_ABO_NEW = new P2Image(ICON_PATH_LONG, "toolbar-abo-new.png", 26, 26);
    public static P2Image ICON_TOOLBAR_ABO_ON = new P2Image(ICON_PATH_LONG, "toolbar-abo-on.png", 26, 26);
