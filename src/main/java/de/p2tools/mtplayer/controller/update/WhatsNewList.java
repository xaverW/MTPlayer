...
public class WhatsNewList extends ArrayList<WhatsNewInfo> {
    ...
    private void addWhatsNew() {
        WhatsNewInfo whatsNewInfo = new WhatsNewInfo(LocalDate.of(2024, 4, 1),
        ...
        whatsNewInfo = new WhatsNewInfo(LocalDate.of(2024, 2, 11),
                ...
                "Es gibt Filme, die den Untertitel im \"Filmtitel\" anzeigen. " +
        ...
        whatsNewInfo = new WhatsNewInfo(LocalDate.of(2024, 2, 11),
                ...
                "Es ist jetzt möglich, durch Texteingabe die angezeigte Liste der Themen " +
                        "zu filtern\n" +
                        "Mit ENTER wird das selektierte Thema gewählt. Um ein Thema auszuwählen, können die " +
        ...
        whatsNewInfo = new WhatsNewInfo(LocalDate.of(2024, 3, 3),
                ...
                "Filmfilter",
                "Die verwendeten Textfilter im Filmfilter werden " +
                        "in einer eigenen Auswahl gespeichert und sind bei " +
                        "einem Programmneustart wieder vorhanden. " +
                        "Eine Auswahl listet sie auf und sie können so auch ausgewählt werden. Es werden " +
                        "dann die Textfilter gefüllt, die anderen Filter bleiben dabei unverändert.", 100);
        add(whatsNewInfo);
        ...
        whatsNewInfo = new WhatsNewInfo(LocalDate.of(2024, 5, 24),
                ...
                "Textfilter",
                "Alle Textfilter im Programm werden jetzt gespeichert. " +
                        "Im Filter kann mit dem Button vor dem Eintrag " +
