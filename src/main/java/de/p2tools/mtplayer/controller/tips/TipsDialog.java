...
public class TipsDialog extends P2DialogExtra {
    ...
    public TipsDialog(ProgData progData) {
        ...
        this.btnFirst = P2Button.getButton(P2IconFactory.P2ICON.P2__TIP_FIRST.getFontIcon(), "ErsteSeite");
        this.btnLast = P2Button.getButton(P2IconFactory.P2ICON.P2__TIP_LAST.getFontIcon(), "Letzte Seite");
        this.btnNext = P2Button.getButton(P2IconFactory.P2ICON.P2__TIP_NEXT.getFontIcon(), "Nächste Seite");
        this.btnPrev = P2Button.getButton(P2IconFactory.P2ICON.P2__TIP_PREV.getFontIcon(), "Vorherige Seite");
