...
public class StarterClass {
    ...
    static void startMsg(Download download) {
        ...
        list.add("Startzeit: " + PDateFactory.FORMATTER_HHmmss.format(download.getStart().getStartTime()));
    ...
    private static void finishedMsg(final Download download) {
        ...
        list.add("Startzeit: " + PDateFactory.FORMATTER_HHmmss.format(start.getStartTime()));
        list.add("Endzeit: " + PDateFactory.FORMATTER_HHmmss.format(new PDate().getTime()));
