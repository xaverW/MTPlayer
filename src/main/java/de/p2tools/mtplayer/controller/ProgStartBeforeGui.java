...
public class ProgStartBeforeGui {
    ...
    public static void workBeforeGui() {
        ...
        if (!load) {
            ...
            WhatsNewFactory.setLastShownToNow(); // muss dann ja nicht angezeigt werden todo: Datum
        ...
        BookmarkLoadSaveFactory.loadBookmark();
    ...
    private static void initLib() {
        P2LibInit.initLib(ProgData.getInstance().primaryStage, ProgConst.PROGRAM_NAME, "",
                ...
                new String[]{
                        ...
                        "de/p2tools/mtplayer/css/pFuncTips.css",
