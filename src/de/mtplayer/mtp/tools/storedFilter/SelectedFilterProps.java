...
public class SelectedFilterProps {
    ...
    public static final int FILTER_DURATIION_MAX_MIN = 150;
    public static final int FILTER_DURATIION_MAX_SEC = FILTER_DURATIION_MAX_MIN * 60;
    ...
    private final IntegerProperty maxDur = new SimpleIntegerProperty(FILTER_DURATIION_MAX_MIN);
